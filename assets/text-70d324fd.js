import{b as n,c as h,j as Y,a as d,k as s,l as Z,m as ee,d as w,u as x,n as oe,e as T,N as re,o as te,h as u,t as ne}from"./app-4d5126d3.js";import{r as m,c as de,a as ae}from"./Space-6f9cfce1.js";import{c as B,h as p,j as l}from"./framework-acfcafcc.js";import{u as se}from"./use-compitable-ad56a9f1.js";const le=n([h("card",`
...
`,[d("strong",`
 ...
 `)]),ge=Object.assign(Object.assign({},x.props),{code:Boolean,type:{type:String,default:"default"},delete:Boolean,strong:Boolean,italic:Boolean,underline:Boolean,depth:[String,Number],tag:String,as:{type:String,validator:()=>!0,default:void 0}}),pe=B({name:"Text",props:ge,setup(e){const{mergedClsPrefixRef:b,inlineThemeDisabled:i}=w(e),o=x("Typography","-text",be,ne,e,b),c=p(()=>{const{depth:f,type:g}=e,a=g==="default"?f===void 0?"textColor":`textColor${f}Depth`:u("textColor",g),{common:{fontWeightStrong:r,fontFamilyMono:v,cubicBezierEaseInOut:C},self:{codeTextColor:z,codeBorderRadius:y,codeColor:S,codeBorder:$,[a]:k}}=o.value;return{"--n-bezier":C,"--n-text-color":k,"--n-font-weight-strong":r,"--n-font-famliy-mono":v,"--n-code-border-radius":y,"--n-code-text-color":z,"--n-code-color":S,"--n-code-border":$}}),t=i?T("text",p(()=>`${e.type[0]}${e.depth||""}`),c,e):void 0;return{mergedClsPrefix:b,compitableTag:se(e,["as","tag"]),cssVars:i?void 0:c,themeClass:t==null?void 0:t.themeClass,onRender:t==null?void 0:t.onRender}},render(){var e,b,i;const{mergedClsPrefix:o}=this;(e=this.onRender)===null||e===void 0||e.call(this);const c=[`${o}-text`,this.themeClass,{[`${o}-text--code`]:this.code,[`${o}-text--delete`]:this.delete,[`${o}-text--strong`]:this.strong,[`${o}-text--italic`]:this.italic,[`${o}-text--underline`]:this.underline}],t=(i=(b=this.$slots).default)===null||i===void 0?void 0:i.call(b);return this.code?l("code",{class:c,style:this.cssVars},this.delete?l("del",null,t):t):this.delete?l("del",{class:c,style:this.cssVars},t):l(this.compitableTag||"span",{class:c,style:this.cssVars},t)}});export{ue as N,pe as a};
