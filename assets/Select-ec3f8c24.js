...
`,[ee("strong",`
 ...
 `,[L("base-loading",`
 color: var(--n-loading-color);
 `),L("base-selection-tags","min-height: var(--n-height);"),$("border, state-border",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
 ...
 `)]),$("render-label",`
 color: var(--n-text-color);
 `)]),Ce("disabled",[le("&:hover",[$("state-border",`
 box-shadow: var(--n-box-shadow-hover);
 border: var(--n-border-hover);
 `)]),ee("focus",[$("state-border",`
 box-shadow: var(--n-box-shadow-focus);
 border: var(--n-border-focus);
 `)]),ee("active",[$("state-border",`
 box-shadow: var(--n-box-shadow-active);
 border: var(--n-border-active);
 `),L("base-selection-label","background-color: var(--n-color-active);"),L("base-selection-tags","background-color: var(--n-color-active);")])]),ee("disabled","cursor: not-allowed;",[$("arrow",`
 ...
 opacity: 0;
 `)]),["warning","error"].map(e=>ee(`${e}-status`,[$("state-border",`border: var(--n-border-${e});`),Ce("disabled",[le("&:hover",[$("state-border",`
 box-shadow: var(--n-box-shadow-hover-${e});
 border: var(--n-border-hover-${e});
 `)]),ee("active",[$("state-border",`
 box-shadow: var(--n-box-shadow-active-${e});
 border: var(--n-border-active-${e});
 `),L("base-selection-label",`background-color: var(--n-color-active-${e});`),L("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),ee("focus",[$("state-border",`
 ...
 `,[_t({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),Lo=Object.assign(Object.assign({},fe.props),{to:st.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},showOnFocus:Boolean,onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),Yo=se({name:"Select",props:Lo,setup(e){const{mergedClsPrefixRef:n,mergedBorderedRef:t,namespaceRef:o,inlineThemeDisabled:i}=vt(e),s=fe("Select","-select",Eo,Tn,e,n),a=I(e.defaultValue),r=oe(e,"value"),b=mt(r,a),u=I(!1),h=I(""),v=B(()=>{const{valueField:l,childrenField:p}=e,P=Ao(l,p);return Co(x.value,P)}),T=B(()=>$o(D.value,e.valueField,e.childrenField)),k=I(!1),f=mt(oe(e,"show"),k),O=I(null),M=I(null),R=I(null),{localeRef:F}=At("Select"),K=B(()=>{var l;return(l=e.placeholder)!==null&&l!==void 0?l:F.value.placeholder}),w=An(e,["items","options"]),C=[],z=I([]),j=I([]),U=I(new Map),X=B(()=>{const{fallbackOption:l}=e;if(l===void 0){const{labelField:p,valueField:P}=e;return H=>({[p]:String(H),[P]:H})}return l===!1?!1:p=>Object.assign(l(p),{value:p})}),D=B(()=>j.value.concat(z.value).concat(w.value)),m=B(()=>{const{filter:l}=e;if(l)return l;const{labelField:p,valueField:P}=e;return(H,A)=>{if(!A)return!1;const E=A[p];if(typeof E=="string")return rt(H,E);const N=A[P];return typeof N=="string"?rt(H,N):typeof N=="number"?rt(H,String(N)):!1}}),x=B(()=>{if(e.remote)return w.value;{const{value:l}=D,{value:p}=h;return!p.length||!e.filterable?l:No(l,m.value,p,e.childrenField)}});function _(l){const p=e.remote,{value:P}=U,{value:H}=T,{value:A}=X,E=[];return l.forEach(N=>{if(H.has(N))E.push(H.get(N));else if(p&&P.has(N))E.push(P.get(N));else if(A){const ne=A(N);ne&&E.push(ne)}}),E}const q=B(()=>{if(e.multiple){const{value:l}=b;return Array.isArray(l)?_(l):[]}return null}),Y=B(()=>{const{value:l}=b;return!e.multiple&&!Array.isArray(l)?l===null?null:_([l])[0]||null:null}),G=$n(e),{mergedSizeRef:V,mergedDisabledRef:Z,mergedStatusRef:c}=G;function y(l,p){const{onChange:P,"onUpdate:value":H,onUpdateValue:A}=e,{nTriggerFormChange:E,nTriggerFormInput:N}=G;P&&de(P,l,p),A&&de(A,l,p),H&&de(H,l,p),a.value=l,E(),N()}function W(l){const{onBlur:p}=e,{nTriggerFormBlur:P}=G;p&&de(p,l),P()}function te(){const{onClear:l}=e;l&&de(l)}function re(l){const{onFocus:p,showOnFocus:P}=e,{nTriggerFormFocus:H}=G;p&&de(p,l),H(),P&&ce()}function pe(l){const{onSearch:p}=e;p&&de(p,l)}function me(l){const{onScroll:p}=e;p&&de(p,l)}function ve(){var l;const{remote:p,multiple:P}=e;if(p){const{value:H}=U;if(P){const{valueField:A}=e;(l=q.value)===null||l===void 0||l.forEach(E=>{H.set(E[A],E)})}else{const A=Y.value;A&&H.set(A[e.valueField],A)}}}function he(l){const{onUpdateShow:p,"onUpdate:show":P}=e;p&&de(p,l),P&&de(P,l),k.value=l}function ce(){Z.value||(he(!0),k.value=!0,e.filterable&&Ne())}function ie(){he(!1)}function ge(){h.value="",j.value=C}const ue=I(!1);function Oe(){e.filterable&&(ue.value=!0)}function ye(){e.filterable&&(ue.value=!1,f.value||ge())}function we(){Z.value||(f.value?e.filterable?Ne():ie():ce())}function Fe(l){var p,P;!((P=(p=R.value)===null||p===void 0?void 0:p.selfRef)===null||P===void 0)&&P.contains(l.relatedTarget)||(u.value=!1,W(l),ie())}function ze(l){re(l),u.value=!0}function Pe(l){u.value=!0}function ke(l){var p;!((p=O.value)===null||p===void 0)&&p.$el.contains(l.relatedTarget)||(u.value=!1,W(l),ie())}function Se(){var l;(l=O.value)===null||l===void 0||l.focus(),ie()}function ae(l){var p;f.value&&(!((p=O.value)===null||p===void 0)&&p.$el.contains(_n(l))||ie())}function g(l){if(!Array.isArray(l))return[];if(X.value)return Array.from(l);{const{remote:p}=e,{value:P}=T;if(p){const{value:H}=U;return l.filter(A=>P.has(A)||H.has(A))}else return l.filter(H=>P.has(H))}}function S(l){J(l.rawNode)}function J(l){if(Z.value)return;const{tag:p,remote:P,clearFilterAfterSelect:H,valueField:A}=e;if(p&&!P){const{value:E}=j,N=E[0]||null;if(N){const ne=z.value;ne.length?ne.push(N):z.value=[N],j.value=C}}if(P&&U.value.set(l[A],l),e.multiple){const E=g(b.value),N=E.findIndex(ne=>ne===l[A]);if(~N){if(E.splice(N,1),p&&!P){const ne=Be(l[A]);~ne&&(z.value.splice(ne,1),H&&(h.value=""))}}else E.push(l[A]),H&&(h.value="");y(E,_(E))}else{if(p&&!P){const E=Be(l[A]);~E?z.value=[z.value[E]]:z.value=C}Ae(),ie(),y(l[A],l)}}function Be(l){return z.value.findIndex(P=>P[e.valueField]===l)}function Ue(l){f.value||ce();const{value:p}=l.target;h.value=p;const{tag:P,remote:H}=e;if(pe(p),P&&!H){if(!p){j.value=C;return}const{onCreate:A}=e,E=A?A(p):{[e.labelField]:p,[e.valueField]:p},{valueField:N}=e;w.value.some(ne=>ne[N]===E[N])||z.value.some(ne=>ne[N]===E[N])?j.value=C:j.value=[E]}}function Ge(l){l.stopPropagation();const{multiple:p}=e;!p&&e.filterable&&ie(),te(),p?y([],[]):y(null,null)}function qe(l){!He(l,"action")&&!He(l,"empty")&&l.preventDefault()}function Ye(l){me(l)}function _e(l){var p,P,H,A,E;switch(l.key){case" ":if(e.filterable)break;l.preventDefault();case"Enter":if(!(!((p=O.value)===null||p===void 0)&&p.isComposing)){if(f.value){const N=(P=R.value)===null||P===void 0?void 0:P.getPendingTmNode();N?S(N):e.filterable||(ie(),Ae())}else if(ce(),e.tag&&ue.value){const N=j.value[0];if(N){const ne=N[e.valueField],{value:Ee}=b;e.multiple&&Array.isArray(Ee)&&Ee.some(Je=>Je===ne)||J(N)}}}l.preventDefault();break;case"ArrowUp":if(l.preventDefault(),e.loading)return;f.value&&((H=R.value)===null||H===void 0||H.prev());break;case"ArrowDown":if(l.preventDefault(),e.loading)return;f.value?(A=R.value)===null||A===void 0||A.next():ce();break;case"Escape":f.value&&(Vn(l),ie()),(E=O.value)===null||E===void 0||E.focus();break}}function Ae(){var l;(l=O.value)===null||l===void 0||l.focus()}function Ne(){var l;(l=O.value)===null||l===void 0||l.focusInput()}function Ze(){var l;f.value&&((l=M.value)===null||l===void 0||l.syncPosition())}ve(),Te(oe(e,"options"),ve);const Xe={focus:()=>{var l;(l=O.value)===null||l===void 0||l.focus()},blur:()=>{var l;(l=O.value)===null||l===void 0||l.blur()}},$e=B(()=>{const{self:{menuBoxShadow:l}}=s.value;return{"--n-menu-box-shadow":l}}),be=i?Ie("select",void 0,$e,e):void 0;return Object.assign(Object.assign({},Xe),{mergedStatus:c,mergedClsPrefix:n,mergedBordered:t,namespace:o,treeMate:v,isMounted:Rn(),triggerRef:O,menuRef:R,pattern:h,uncontrolledShow:k,mergedShow:f,adjustedTo:st(e),uncontrolledValue:a,mergedValue:b,followerRef:M,localizedPlaceholder:K,selectedOption:Y,selectedOptions:q,mergedSize:V,mergedDisabled:Z,focused:u,activeWithoutMenuOpen:ue,inlineThemeDisabled:i,onTriggerInputFocus:Oe,onTriggerInputBlur:ye,handleTriggerOrMenuResize:Ze,handleMenuFocus:Pe,handleMenuBlur:ke,handleMenuTabOut:Se,handleTriggerClick:we,handleToggle:S,handleDeleteOption:J,handlePatternInput:Ue,handleClear:Ge,handleTriggerBlur:Fe,handleTriggerFocus:ze,handleKeydown:_e,handleMenuAfterLeave:ge,handleMenuClickOutside:ae,handleMenuScroll:Ye,handleMenuKeydown:_e,handleMenuMousedown:qe,mergedTheme:s,cssVars:i?void 0:$e,themeClass:be==null?void 0:be.themeClass,onRender:be==null?void 0:be.onRender})},render(){return d("div",{class:`${this.mergedClsPrefix}-select`},d(zn,null,{default:()=>[d(Pn,null,{default:()=>d(_o,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,n;return[(n=(e=this.$slots).arrow)===null||n===void 0?void 0:n.call(e)]}})}),d(Mn,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===st.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>d(Pt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,n,t;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),vn(d(Fo,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(n=this.menuProps)===null||n===void 0?void 0:n.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(t=this.menuProps)===null||t===void 0?void 0:t.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var o,i;return[(i=(o=this.$slots).empty)===null||i===void 0?void 0:i.call(o)]},action:()=>{var o,i;return[(i=(o=this.$slots).action)===null||i===void 0?void 0:i.call(o)]}}),this.displayDirective==="show"?[[gn,this.mergedShow],[pt,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[pt,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{Yo as N};
