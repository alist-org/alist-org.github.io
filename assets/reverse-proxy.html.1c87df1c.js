import{_ as s,W as i,X as d,Y as a,a0 as e,Z as r,$ as l,a1 as t,y as c}from"./framework.00b47ed6.js";const o={},u=a("h1",{id:"反向代理",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#反向代理","aria-hidden":"true"},"#"),e(" 反向代理")],-1),v=t(`<h2 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> nginx</h2><p>在网站配置文件的 server 字段中添加</p><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>location / {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="宝塔设置反向代理简单示范" tabindex="-1"><a class="header-anchor" href="#宝塔设置反向代理简单示范" aria-hidden="true">#</a> 宝塔设置反向代理简单示范</h2><p>首先新建一个站点，<strong>Alist启动程序</strong> 在不在这个站点文件夹内都无所谓，然后照着下图添加即可。</p><ul><li>还有就是如果你要用宝塔开启 <strong>SSL(HTTPS)</strong> 你需要在反向代理之前添加不然无法开启SSL <ul><li>如果你已经添加了反向代理，可以先停止**(图片里面哪个开启代理按钮关了它就行)**，开启了SSL再把反向代理打开即可</li></ul></li></ul><p><img src="https://alist-doc.nn.ci/assets/images/BT-Proxy-5913c3786afba1417362c71f0af73ea9.png" alt="BT"></p>`,16);function p(m,h){const n=c("RouterLink");return i(),d("div",null,[u,a("p",null,[e("程序默认监听 5244 端口。如有修改，请一并修改下列配置中的端口号。如果你使用反向代理，建议你设置"),r(n,{to:"/zh/config/configuration.html#site_url"},{default:l(()=>[e("site_url")]),_:1}),e("，以帮助alist更好的工作。")]),v])}const x=s(o,[["render",p],["__file","reverse-proxy.html.vue"]]);export{x as default};
