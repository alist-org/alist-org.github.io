import{b as I,c as b,a as ze,E as Z,h as $e,e as x,d as l,v as U,f as ee,w as Be,u as Se,F as Te,G as R}from"./app-55afeb55.js";import{k as Pe,m as ke,n as Re,o as He,q as Ee,u as Ie,b as je,d as J,e as Fe,s as Oe,t as De,j as Ne,l as _e,h as r}from"./Space-426f3535.js";import{c as oe,H as Ge,r as S,B as Ke,v as Me,j as p,m as Ve,h as H}from"./framework-65876511.js";function X(e){return e.replace(/#|\(|\)|,|\s/g,"_")}const We=I("base-wave",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
...
`),qe=oe({name:"BaseWave",props:{clsPrefix:{type:String,required:!0}},setup(e){Pe("-base-wave",We,Ge(e,"clsPrefix"));const f=S(null),h=S(!1);let u=null;return Ke(()=>{u!==null&&window.clearTimeout(u)}),{active:h,selfRef:f,play(){u!==null&&(window.clearTimeout(u),h.value=!1,u=null),Me(()=>{var v;(v=f.value)===null||v===void 0||v.offsetHeight,h.value=!0,u=window.setTimeout(()=>{h.value=!1,u=null},1e3)})}}},render(){const{clsPrefix:e}=this;return p("div",{ref:"selfRef","aria-hidden":!0,class:[`${e}-base-wave`,this.active&&`${e}-base-wave--active`]})}}),{cubicBezierEaseInOut:C}=ze;function Qe({duration:e=".2s",delay:f=".1s"}={}){return[b("&.fade-in-width-expand-transition-leave-from, &.fade-in-width-expand-transition-enter-to",{opacity:1}),b("&.fade-in-width-expand-transition-leave-to, &.fade-in-width-expand-transition-enter-from",`
 ...
 margin-left ${e} ${C},
 margin-right ${e} ${C};
 `)]}function $(e){return Z(e,[255,255,255,.16])}function E(e){return Z(e,[0,0,0,.12])}const Le=$e("n-button-group"),Ye=b([I("button",`
 margin: 0;
